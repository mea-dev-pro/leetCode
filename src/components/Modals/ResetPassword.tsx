...
const ResetPassword: React.FC<ResetPasswordProps> = () => {
    ...
    return <form className='space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8'>
        ...
        <p className='text-sm text-white'>
            Forgotten your passsword? Enter your e-mail address below, and we&apos;ll send you an e-mail allowing you to reset it.
        </p>
        <div>
        ...
        <button 
        type='submit'
        className='w-full text-white focus:ring-4 focus:ring-blue-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center
